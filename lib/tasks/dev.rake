...
namespace :dev do
  ...
  task :setup => :environment do
      ...
      r.save
      t = Task.new({status: 'N', restaurant: r, user_id: 1, url: 'http://doll1027.pixnet.net/blog/post/171945207-%E6%9D%BF%E6%A9%8B%E2%94%82%E8%96%84%E5%A4%9A%E7%BE%A9-bite-2-eat%E2%80%A7q%E6%84%9F%E6%89%8B%E5%B7%A5%E6%8A%AB%E8%96%A9%E3%80%90%E8%AA%A0%E5%93%81%E6%9D%BF'})
      t.save!

      puts "Create system task - 武藏武骨"
      r = Restaurant.new({name: '左營‧神社風麵屋武藏武骨黑雷拉麵', address: '高雄市左營區站前北路1號', telephone: '07-5811112'})
      r.save
      t = Task.new({status: 'N', restaurant: r, user_id: 1, url: 'http://rmlove30.pixnet.net/blog/post/54112066-%E5%B7%A6%E7%87%9F%E2%80%A7%E7%A5%9E%E7%A4%BE%E9%A2%A8%E9%BA%B5%E5%B1%8B%E6%AD%A6%E8%97%8F%E6%AD%A6%E9%AA%A8%E9%BB%91%E9%9B%B7%E6%8B%89%E9%BA%B5'})
      t.save!
  end
end